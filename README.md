...
- The theme chooser progressively mounts a small batch of memoized options and renders each palette as one lazily cached stripe; do not synchronously mount the full theme catalogue, precompute every preview at startup, or recreate a DOM node for every swatch.
