...
- The theme chooser progressively mounts a small batch of memoized options and renders each palette as one precomputed stripe; do not synchronously mount the full theme catalogue or recreate a DOM node for every swatch.
