...
requireText("src/lib/physics/scheduler.js", physicsScheduler, "for (const s of active) s.step(FIXED_DT)");
requireText("src/lib/physics/scheduler.js", physicsScheduler, "for (const s of active) {\n    s.render(alpha);");
