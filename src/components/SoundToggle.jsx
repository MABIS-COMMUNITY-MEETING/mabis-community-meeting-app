...
export default function SoundToggle({ className = "" }) {
  ...
  return (
    <button
      ...
      aria-pressed={on}
      className={`hidden sm:flex h-9 items-center gap-2 border border-foreground/30 bg-bone px-3 tech-label text-foreground hover:bg-foreground hover:text-bone transition-colors ${className}`}
    >
