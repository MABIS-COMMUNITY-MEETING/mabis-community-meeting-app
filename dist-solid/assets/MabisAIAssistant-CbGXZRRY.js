...
`),g.forEach(e=>{const i=D.filter(a=>a.week_label===e),m=o.find(a=>a.week_label===e&&a.title==="__meeting_notes__");t+=`  ${z(e)} (${i.length} topics):
